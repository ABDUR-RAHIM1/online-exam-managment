...
export default function Sidebar() {
    ...
    return (
        <div className=" relative md:w-[28%]">
            ...
            {/* Sidebar */}
            <aside
                className={`fixed inset-y-0 left-0 z-[10] py-24 md:py-10 bg-blue-500 text-white p-4 transform transition-transform duration-300 md:relative md:translate-x-0 md:w-full h-screen ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
                    }`}
            >
